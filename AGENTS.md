...
本仓库为 Shipyard monorepo（NestJS + Vue 3 + Prisma）。与 AI 协作时建议优先查阅：
...
全局规则摘要见 [`.cursor/rules/shipyard-plan-workflow.mdc`](.cursor/rules/shipyard-plan-workflow.mdc)（与上表第一行一致）。
